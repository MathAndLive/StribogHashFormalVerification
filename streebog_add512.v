...
Module Info.
  ...
  Definition source_file := "streebog_add512.c".
      ...
      (Ssequence
        ...
        (Ssequence
          ...
          (Ssequence
            (Sset _sum
              (Ebinop Oadd
                (Ebinop Oadd (Etempvar _left tulong)
                  (Ederef
                    (Ebinop Oadd
                      (Efield
                        (Ederef
                          ...
                          (Tstruct _streebog_uint512 noattr)) _qword
                        (tarray tulong 8)) (Etempvar _i tint) (tptr tulong))
                    tulong) tulong) (Etempvar _carry tulong) tulong))
            (Ssequence
...
((___compcert_va_int32,
 ...
 (___builtin_debug,
   Gfun(External (EF_external "__builtin_debug"
     ...
     (tint :: nil) tvoid
     {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|})) ::
 (_streebog_add512, Gfun(Internal f_streebog_add512)) :: nil).

Definition public_idents : list ident :=
(_streebog_add512 :: ___builtin_debug :: ___builtin_write32_reversed ::
